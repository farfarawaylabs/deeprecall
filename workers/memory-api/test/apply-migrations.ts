 ...
 * of the project (verified in workers/ingestion). memory-api has no
 * module-mocking suites today, but the direct-import pattern keeps that
 * foot-gun from ever firing here.
 *
