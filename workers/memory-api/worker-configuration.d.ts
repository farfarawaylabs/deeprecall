/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: f64e58009e27ed44c9e8725a38a20588)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    ADMIN_KEY: string;
    INGESTION: Fetcher /* deeprecall-ingestion-dev */;
    RETRIEVAL: Fetcher /* deeprecall-retrieval-dev */;
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'AXIOM_API_TOKEN' | 'AXIOM_DATASET' | 'ANTHROPIC_API_KEY' | 'ADMIN_KEY'>
  > {}
}
