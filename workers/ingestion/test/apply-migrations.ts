 ...
 * of the project (verified: test/steps/reconcile.test.ts's @deeprecall/ai
 * mock stops applying and the real LLM client runs). The direct import
 * executes after the importing file's hoisted vi.mock calls, so both work.
 *
