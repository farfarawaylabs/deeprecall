/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: e6023fb8871c94e2f4bb827bc1432574)
// HAND-EDITED: DB_default was removed (C9) and DATA keeps its typed Service
// entrypoint. Do NOT regenerate blindly - `wrangler types` with newer workerd
// restructures this file and drops the typed DATA binding; re-apply both edits
// if you regenerate.
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    ADMIN_KEY: string;
    DATA: Service<import('@deeprecall/worker-data').DataService>;
  }
}
