/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: d40b72f9e09444038dfffdbc0b4e803c)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ANTHROPIC_API_KEY' | 'AXIOM_API_TOKEN' | 'AXIOM_DATASET'>
  > {}
}
